 ...
 * 
 * @typedef {(msg: Message, cmd: types.Command) => Promise<void>} BeforeAuthorizeCommandHook
...
export default class TelegramCommander {
  ...
  /** @type {BeforeAuthorizeCommandHook[]} */           beforeAuthorizeCommandHooks = []
  /** @type {AfterAddCommandHook[]} */                  afterAddCommandHooks = []
